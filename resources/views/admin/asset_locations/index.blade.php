        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium mt-0.5">Kelola penanggung jawab, gedung, lantai, ruangan, dan pemetaan lokasi fisik aset.</p>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm">
            <form action="{{ url()->current() }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-end">
                ...
                <div class="lg:col-span-8 space-y-1">
                    ...
                    <div class="relative">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Kode, nama, atau gedung..."
                ...
                <table class="w-full text-left border-collapse min-w-[850px]">
                    <thead>
                        <tr class="bg-slate-50/80 dark:bg-slate-800/50 border-b border-slate-200/80 dark:border-slate-800 text-slate-400 dark:text-slate-400 uppercase text-[10px] font-bold tracking-wider">
                            ...
                            <th class="px-6 py-3.5">Gedung</th>
            ...
            <div class="p-6 overflow-y-auto space-y-4">
                <form id="crudForm" method="POST" action="{{ route('admin.asset_locations.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Gedung</label>
                            <input type="text" name="building" id="loc_building" placeholder="Gedung A" class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-800 dark:text-slate-100 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                        </div>
